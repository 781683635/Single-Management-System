					...
					<div class="nav clear bor-ccc bor-t-none bor-b-none bor-r-none">
						...
						<div class="col-sm-2 pl-0 pr-0 pt-5 cur-p poa-r overflow-h ml-1">
							<div class="nav-list">
								...
								<div class="t-none pt-20 news-hovbg" style="  background:  -webkit-linear-gradient(top, #A446A4 0%,#893B8A 60%,#843E85 80%, #995F99 100%);
  background:  -o-linear-gradient(bottom, #A446A4 0%,#893B8A 60%,#843E85 80%, #995F99 100%);
  background:  -moz-linear-gradient(bottom, #A446A4 0%,#893B8A 60%,#843E85 80%, #995F99 100%);
  background:  linear-gradient(to bottom, #A446A4 0%,#893B8A 60%,#843E85 80%, #995F99 100%)">
									<a href="${pageContext.request.contextPath}/admin.do">
										<h3 class="f-16 pl-20 col-white">管理中心</h3>
										<p class="mt-5 line-h-15 f-11 pl-5 text-line-2 let-spa-1 col-white">管理员的中心，管理所有功能</p>
									</a>
								</div>
							</div>
						</div>
