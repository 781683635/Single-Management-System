					...
					<div class="nav clear bor-ccc bor-t-none bor-b-none bor-r-none">
						...
						<div class="col-sm-2 pl-0 pr-0 pt-5 cur-p poa-r overflow-h ml-1">
							<div class="nav-list2">
								...
								<div class="t-none pt-20 educ-hovbg">
									<a href="${pageContext.request.contextPath}/history.do">
										<h3 class="f-16 col-black pl-20">历史查询</h3>
										<p class="mt-5 line-h-15 f-11 pl-5 text-line-2 let-spa-1">查询所有的历史和记录，打印报表等</p>
									</a>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-2 pl-0 pr-0 pt-5 cur-p poa-r overflow-h ml-1">
							<div class="nav-list">
								...
								<div class="t-none pt-20 research-hovbg" style="background:  -webkit-linear-gradient(top, #E93A47 0%,#CA323D 60%,#B72D37 80%, #C6585D 100%);
  background:  -o-linear-gradient(bottom, #E93A47 0%,#CA323D 60%,#B72D37 80%, #C6585D 100%);
  background:  -moz-linear-gradient(bottom, #E93A47 0%,#CA323D 60%,#B72D37 80%, #C6585D 100%);
  background:  linear-gradient(to bottom, #E93A47 0%,#CA323D 60%,#B72D37 80%, #C6585D 100%)">
									<a href="${pageContext.request.contextPath}/usercenter.do">
										<h3 class="f-16 pl-20 col-white">用户中心</h3>
										<p class="mt-5 line-h-15 f-11 pl-5 text-line-2 let-spa-1 col-white">用户自己的主页，包括账号的设置和修改功能</p>
									</a>
								</div>
							</div>
						</div>
