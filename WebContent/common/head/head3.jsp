					...
					<div class="nav clear bor-ccc bor-t-none bor-b-none bor-r-none">
						...
						<div class="col-sm-2 pl-0 pr-0 pt-5 cur-p poa-r overflow-h ml-1">
							<div class="nav-list">
								...
								<div class="t-none pt-20 fund-hovbg" style="background:  -webkit-linear-gradient(top, #00BCD4 0%,#3bc2ff 60%,#19b8ff 80%, #03A9F4 100%);
  background:  -o-linear-gradient(bottom, #00BCD4 0%,#3bc2ff 60%,#19b8ff 80%, #03A9F4 100%);
  background:  -moz-linear-gradient(bottom, #00BCD4 0%,#3bc2ff 60%,#19b8ff 80%, #03A9F4 100%);
  background:  linear-gradient(to bottom, #00BCD4 0%,#3bc2ff 60%,#19b8ff 80%, #03A9F4 100%)">
									<a href="${pageContext.request.contextPath}/repair.do">
										<h3 class="f-16 pl-20 col-white">故障中心</h3>
										<p class="mt-5 line-h-15 f-11 pl-5 text-line-2 let-spa-1 col-white">管理故障中心，线路设备的报修及后续问题处理</p>
									</a>
								</div>
							</div>
						</div>
