					...
					<div class="nav clear bor-ccc bor-t-none bor-b-none bor-r-none">
						...
						<div class="col-sm-2 pl-0 pr-0 pt-5 cur-p poa-r overflow-h ml-1">
							<div class="nav-list2">
								...
								<div class="t-none pt-20 serve-hovbg" style="  background:  -webkit-linear-gradient(top, #ffb342 0%,#ff8f19 60%,#ff9800 80%, #ffa829 100%);
  background:  -o-linear-gradient(bottom, #ffb342 0%,#ff8f19 60%,#ff9800 80%, #ffa829 100%);
  background:  -moz-linear-gradient(bottom, #ffb342 0%,#ff8f19 60%,#ff9800 80%, #ffa829 100%);
  background:  linear-gradient(to bottom, #ffb342 0%,#ff8f19 60%,#ff9800 80%, #ffa829 100%)">
									<a href="${pageContext.request.contextPath}/workcenter.do">
										<h3 class="f-16 pl-20 col-white">员工中心</h3>
										<p class="mt-5 line-h-15 f-11 pl-5 text-line-2 let-spa-1 col-white">员工的主页，员工个人信息的完善</p>
									</a>
								</div>
							</div>
						</div>
