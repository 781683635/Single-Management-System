...
<div class="wrap ">
	<jsp:include page="/common/head/head7.jsp"/>
		<div class="container clear">
			<jsp:include page="/common/menu/menu-admin5.jsp"/>
			<!-- 内容开始 -->
			<div class="col-sm-10">
				<div class="row">
					<h3 class="f-14 gradient-gray clear">
						<span class="pull-left pd-10 line-h-20 f-18">添加新员工</span>
					</h3>
				</div>
				<div>
					
					<form id="news_addForm" method="post" class="sky-form userchange-form" action="${pageContext.request.contextPath }/addworkersave.do">
								<!-- 账号 -->	      
								<div class="f-13 mb-15 mt-15 clear">
									...
									<div class="col-xs-9 col-sm-10 col-md-11 pl-0 pr-5">
										<div class="clear">
										<input type="text" name="name" value="" class="ipt-text radius0" >
										</div>
									</div>
								</div>
								<!-- 密码 -->
								<div class="f-13 mb-15 mt-15 clear">
									...
									<div class="col-xs-9 col-sm-10 col-md-11 pl-0 pr-5">
										<div class="clear">
											<input type="password" name="workerPwd" value="" class="ipt-text radius0" >
										</div>
									</div>
								</div> 
								<!-- 真实姓名 -->
								<div class="f-13 mb-15 mt-15 clear">
									...
									<div class="col-xs-9 col-sm-10 col-md-11 pl-0 pr-5">
										<div class="clear">
											<input type="text" name="roleName" value="" class="ipt-text radius0" >
										</div>
									</div>
								</div>
								<!-- 手机 -->
								<div class="f-13 mb-15 mt-15 clear">
									...
									<div class="col-xs-9 col-sm-10 col-md-11 pl-0 pr-5">
										<div class="clear">
											<input type="text" name="workerMobile" value=""
								...
								<div class="f-13 mb-15 mt-15 clear">
									...
									<div class="col-xs-9 col-sm-10 col-md-11 pl-0 pr-5">
										<div class="clear">
											<input type="text" name="workerEmail" value=""
											class="ipt-text radius0">
										</div>
									</div>
								</div>
								...
								<div class="f-13 mb-15 mt-15 clear">
									...
									<div class="col-xs-9 col-sm-10 col-md-11 pl-0 pr-5">
										<div class="clear">
											<input type="text" name="workAbout" value=""
											class="ipt-text radius0">
										</div>
									</div>
								</div>
