...
<div class="wrap ">
	<jsp:include page="/common/head/head7.jsp"/>
		<div class="container clear">
			<jsp:include page="/common/menu/menu-admin4.jsp"/>
			<!-- 内容开始 -->
			<div class="col-sm-10">
				<div class="row">
					<h3 class="f-14 gradient-gray clear">
						<span class="pull-left pd-10 line-h-20 f-18">添加新用户</span>
					</h3>
				</div>
				<div>
					<form id="news_addForm" method="post" class="sky-form userchange-form" action="${pageContext.request.contextPath }/addusersave.do">		
						<!-- 账号 -->	      
