...
<div class="wrap ">
	<jsp:include page="/common/head/head5.jsp"/>
		<div class="container clear">
			<jsp:include page="/common/menu/menu-user2.jsp"/>
			<!-- 内容开始 -->
			<div class="col-sm-10">
						<div>
							<form id="news_addForm" method="post" class="sky-form userchange-form" action="${pageContext.request.contextPath }/usersaveuser.do">		
								<!-- 账号 -->	      
