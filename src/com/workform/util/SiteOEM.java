...
public class SiteOEM{
	...
	public String	_Name = "矿业圈";
	public String	_Seo_Name = "矿业圈";
	public String	_Slogan = _Name + "=互联网+矿业";
	public String 	_NameEn = "GoldenLend";//MiningCircle KuangYeQuan | GoldenLend
	public String 	_Website = "http://www.miningcircle.com";
	public String 	_Address = "北京朝阳区建国门外大街中海广场5层（100020）";
	public String 	_Tel = "400-010-0456";
	public String 	_EMail = "info@miningcircle.com";
	...
	private void setData(){
		...
		default:
			if ("en".equals(_lg)){//english
				_Name = "MiningCircle";
				_Slogan = _Name + "=Internet+Mining";
				_Seo_Name = "MiningCircle";
			}else{
				_lg = "cn";
				_Name = "矿业圈";
				_Slogan = _Name + "=互联网+矿业";
				_Seo_Name = "矿业圈-MiningCircle";
			}
			_IconPath = "/favicon.ico";
			_LogoPath = "/images/24.png";
			_NameEn = "MiningCircle";// KuangYeQuan | GoldenLend
			_Website = "http://www.miningcircle.com";
			_EMail = "info@miningcircle.com";
			break;
		}
		//写入cookie
...
//		HttpSession session = request.getSession();
	 ...
	 * 设置网站域名类型
	 * */
	private void setSite(String strWebName){

		short typeTmp = _SF_TYPE_MC;//0:mc.com 1:gl.com
